...
export const categories = [
  ...
  { id: 'ai-software', name: 'AI & Software', icon: '🤖' },
  { id: 'movies-ott', name: 'Movies & OTT', icon: '🎬' },
  { id: 'gaming', name: 'Gaming', icon: '🎮' },
  { id: 'music-entertainment', name: 'Music & Entertainment', icon: '🎵' },
  { id: 'fashion-streetwear', name: 'Fashion & Streetwear', icon: '👕' },
  { id: 'beauty-skincare', name: 'Beauty & Skincare', icon: '💄' },
  { id: 'automobiles', name: 'Automobiles', icon: '🚗' },
  { id: 'mobility-ev', name: 'Mobility & EV', icon: '⚡' },
  { id: 'food-beverages', name: 'Food & Beverages', icon: '🍔' },
  { id: 'lifestyle-home', name: 'Lifestyle & Home', icon: '🏠' },
  { id: 'startups-products', name: 'Startups & Products', icon: '🚀' },
  { id: 'creator-tools-audio', name: 'Creator Tools & Audio', icon: '🎧' },
  { id: 'collectibles-culture', name: 'Collectibles & Culture', icon: '💎' },
  { id: 'sports-equipment', name: 'Sports & Equipment', icon: '⚽' },
  { id: 'travel-experiences', name: 'Travel & Experiences', icon: '✈️' },
];
